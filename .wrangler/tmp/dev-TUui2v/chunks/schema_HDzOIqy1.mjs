...
const pages = sqliteTable("pages", {
  ...
  contentBlocks: text("content_blocks", { mode: "json" }).$type().notNull().default([]),
...
const pageRevisions = sqliteTable("page_revisions", {
  id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
  pageId: text("page_id").notNull().references(() => pages.id, { onDelete: "cascade" }),
  title: text("title").notNull(),
  contentBlocks: text("content_blocks", { mode: "json" }).$type().notNull(),
...
const abTests = sqliteTable("ab_tests", {
  id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
  name: text("name").notNull(),
  pageId: text("page_id").notNull().references(() => pages.id, { onDelete: "cascade" }),
  variants: text("variants", { mode: "json" }).$type().notNull().default([]),
...
const activityLog = sqliteTable("activity_log", {
  ...
  // 'create', 'update', 'delete', 'publish', 'login', etc.
  entityType: text("entity_type").notNull(),
  // 'page', 'media', 'user', 'settings', etc.
  entityId: text("entity_id"),
  metadata: text("metadata", { mode: "json" }).$type(),
  createdAt: integer("created_at", { mode: "timestamp" }).notNull().$defaultFn(() => /* @__PURE__ */ new Date())
});
const translations = sqliteTable("translations", {
  id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
  pageId: text("page_id").notNull().references(() => pages.id, { onDelete: "cascade" }),
...
export { mapResultRow as A, isDriverValueEncoder as B, Column as C, isSQLWrapper as D, Placeholder as E, StringChunk as F, templates as G, translations as H, Param as P, SQL as S, Table as T, ViewBaseConfig as V, WithSubquery as W, sql as a, activityLog as b, abTests as c, siteSettings as d, pageRevisions as e, formSubmissions as f, entityKind as g, getTableUniqueName as h, is as i, Subquery as j, View as k, SQLiteTable as l, media as m, getTableName as n, orderSelectedFields as o, pages as p, SQLiteColumn as q, getTableColumns as r, schema as s, getTableLikeName as t, user as u, haveSameKeys as v, applyMixins as w, Columns as x, mapUpdateSet as y, fillPlaceholders as z };
